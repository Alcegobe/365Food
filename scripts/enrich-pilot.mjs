#!/usr/bin/env node
// Enrichit data/recipes.json avec composantes + ingredients pour une 1re vague
// de recettes "pilotes". Idempotent : relancer écrase juste ces champs.
...
// Rayons (pour le tri de la liste de courses) : voir COURSES_RAYONS dans app.js.
...
const PILOT = {
  ...
  "burger-boeuf-sauce-light": {
    ...
    ingredients: [
      i("Bœuf haché 5%", 250, "g", BV),
      i("Pain à burger complet", 2, "pièce", BO),
      i("Tomate", 1, "pièce", FL),
      i("Oignon rouge", 0.5, "pièce", FL),
      i("Salade (feuilles)", 4, "feuille", FL),
      i("Cheddar", 2, "tranche", CR),
      i("Yaourt grec 0%", 2, "c.à.s", CR),
      i("Ketchup", 1, "c.à.s", SC),
    ],
  },
  "cheeseburger-frites-airfryer": {
    ...
    ingredients: [
      ...
      i("Pain à burger complet", 2, "pièce", BO),
      i("Cheddar", 2, "tranche", CR),
      i("Pommes de terre", 400, "g", FL),
      i("Huile d'olive", 1, "c.à.s", EP),
      i("Cornichon", 4, "pièce", SC),
    ],
  },
  "kebab-poulet-sauce-blanche": {
    composantes: { proteine: "Poulet mariné", legume: "Crudités", feculent: "Pain pita complet" },
    ingredients: [
      i("Filet de poulet", 300, "g", BV),
      i("Pain pita complet", 2, "pièce", BO),
      i("Tomate", 1, "pièce", FL),
      i("Oignon", 0.5, "pièce", FL),
      i("Salade (feuilles)", 4, "feuille", FL),
      i("Yaourt grec 0%", 3, "c.à.s", CR),
      i("Ail", 1, "gousse", FL),
      i("Épices kebab (cumin, paprika)", 1, "c.à.c", EP),
    ],
  },
  "pizza-margherita": {
    composantes: { proteine: "Mozzarella", legume: "Tomate, basilic", feculent: "Pâte à pizza" },
    ingredients: [
      i("Pâte à pizza", 1, "pièce", BO),
      i("Sauce tomate", 100, "g", SC),
      i("Mozzarella", 125, "g", CR),
      i("Basilic frais", 1, "pincée", FL),
      i("Huile d'olive", 1, "c.à.s", EP),
    ],
  },
  "wok-poulet-legumes": {
    ...
    ingredients: [
      i("Filet de poulet", 300, "g", BV),
      i("Mélange de légumes wok", 400, "g", FL),
      i("Riz", 150, "g", EP),
      i("Sauce soja", 2, "c.à.s", SC),
      i("Gingembre", 1, "c.à.c", FL),
      i("Ail", 1, "gousse", FL),
      i("Huile de sésame", 1, "c.à.c", EP),
    ],
  },
  "spaghetti-bolognaise": {
    ...
    ingredients: [
      i("Bœuf haché 5%", 250, "g", BV),
      i("Spaghetti", 180, "g", EP),
      i("Tomates concassées", 400, "g", EP),
      i("Oignon", 1, "pièce", FL),
      i("Carotte", 1, "pièce", FL),
      i("Ail", 1, "gousse", FL),
      i("Parmesan", 20, "g", CR),
    ],
  },
  "saumon-teriyaki-brocoli": {
    ...
    ingredients: [
      i("Pavé de saumon", 2, "pièce", PO),
      i("Brocoli", 400, "g", FL),
      i("Riz", 150, "g", EP),
      i("Sauce soja", 2, "c.à.s", SC),
      i("Miel", 1, "c.à.c", EP),
      i("Graines de sésame", 1, "c.à.c", EP),
    ],
  },
  "cabillaud-ecrase-pdt": {
    composantes: { proteine: "Cabillaud", legume: "Persil, citron", feculent: "Pommes de terre" },
    ingredients: [
      i("Dos de cabillaud", 2, "pièce", PO),
      i("Pommes de terre", 400, "g", FL),
      i("Lait demi-écrémé", 50, "ml", CR),
      i("Citron", 0.5, "pièce", FL),
      i("Persil", 1, "pincée", FL),
      i("Huile d'olive", 1, "c.à.s", EP),
    ],
  },
  ...
  "chili-con-carne-riz": {
    ...
    ingredients: [
      i("Bœuf haché 5%", 250, "g", BV),
      i("Haricots rouges", 240, "g", EP),
      i("Tomates concassées", 400, "g", EP),
      i("Oignon", 1, "pièce", FL),
      i("Poivron", 1, "pièce", FL),
      i("Riz", 150, "g", EP),
      i("Cumin & paprika", 1, "c.à.c", EP),
    ],
  },
  "pokebowl-saumon": {
    composantes: { proteine: "Saumon cru", legume: "Avocat, concombre, edamame", feculent: "Riz à sushi" },
    ingredients: [
      i("Saumon frais (qualité sashimi)", 200, "g", PO),
      i("Riz à sushi", 150, "g", EP),
      i("Avocat", 1, "pièce", FL),
      i("Concombre", 0.5, "pièce", FL),
      i("Edamame", 100, "g", SU),
      i("Sauce soja", 2, "c.à.s", SC),
      i("Graines de sésame", 1, "c.à.c", EP),
    ],
  ...
  "cordon-bleu-poulet-airfryer": {
    ...
    ingredients: [
      i("Escalope de poulet", 2, "pièce", BV),
      i("Jambon", 2, "tranche", BV),
      i("Emmental", 2, "tranche", CR),
      i("Chapelure (panko)", 60, "g", EP),
      i("Œuf", 1, "pièce", CR),
      i("Farine", 30, "g", EP),
    ],
  },
  "crevettes-ail-persil": {
    ...
    ingredients: [
      i("Crevettes décortiquées", 300, "g", PO),
      i("Riz", 150, "g", EP),
      i("Ail", 2, "gousse", FL),
      i("Persil", 1, "pincée", FL),
      i("Citron", 0.5, "pièce", FL),
  ...
  "riz-saute-poulet-legumes": {
    ...
    ingredients: [
      i("Filet de poulet", 250, "g", BV),
      i("Riz", 150, "g", EP),
      i("Mélange de légumes", 300, "g", FL),
      i("Œuf", 1, "pièce", CR),
      i("Sauce soja", 2, "c.à.s", SC),
      i("Ail", 1, "gousse", FL),
    ],
  ...
  "steak-hache-haricots-verts": {
    ...
    ingredients: [
      i("Steak haché 5%", 2, "pièce", BV),
      i("Haricots verts", 300, "g", FL),
      i("Pommes de terre", 300, "g", FL),
      i("Ail", 1, "gousse", FL),
      i("Huile d'olive", 1, "c.à.s", EP),
    ],
  },
  "nouilles-sautees-poulet": {
    ...
    ingredients: [
      i("Filet de poulet", 250, "g", BV),
      i("Nouilles chinoises", 180, "g", EP),
      i("Mélange de légumes wok", 300, "g", FL),
      i("Sauce soja", 2, "c.à.s", SC),
      i("Gingembre", 1, "c.à.c", FL),
      i("Ail", 1, "gousse", FL),
    ],
  ...
  "porridge-banane-cannelle": {
    ...
    ingredients: [
      i("Flocons d'avoine", 80, "g", EP),
      i("Lait demi-écrémé", 250, "ml", CR),
      i("Banane", 1, "pièce", FL),
      i("Cannelle", 1, "pincée", EP),
      i("Whey vanille (option)", 1, "c.à.s", EP),
    ],
  },
  "oeufs-plat-avocat-toast": {
    ...
    ingredients: [
      i("Œuf", 4, "pièce", CR),
      i("Pain complet", 2, "tranche", BO),
      i("Avocat", 1, "pièce", FL),
      i("Huile d'olive", 1, "c.à.c", EP),
    ],
  },
  ...
  "oeufs-brouilles-cottage": {
    ...
    ingredients: [
      i("Œuf", 4, "pièce", CR),
      i("Cottage cheese", 100, "g", CR),
      i("Ciboulette", 1, "pincée", FL),
      i("Pain complet", 2, "tranche", BO),
    ],
  },
  "overnight-oats-cacahuete-cacao": {
    ...
    ingredients: [
      i("Flocons d'avoine", 80, "g", EP),
      i("Lait demi-écrémé", 200, "ml", CR),
      i("Beurre de cacahuète", 1, "c.à.s", EP),
      i("Cacao maigre", 1, "c.à.c", EP),
      i("Yaourt grec 0%", 2, "c.à.s", CR),
    ],
  },
  "egg-muffins-jambon": {
...
console.log(`Enrichi ${n} recettes pilotes (composantes + ingredients).`);
